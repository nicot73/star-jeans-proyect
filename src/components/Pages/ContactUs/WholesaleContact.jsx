...
import wholesalerContactImage from '../../../assets/WholesalerContactImg.jpg';

const WholesaleContact = () => {
  return (
    <>
        <div id='toTop' className='contactHeader'>
            <img src={wholesalerContactImage} alt="contactImage" />
        </div>
            ...
            <div className="formContainer">
                <form action="https://formsubmit.co/starjeansventamayorista@gmail.com" method="POST">
                    ...
                    <div className="formGroup">
                        <label htmlFor="provincia-localidad">
                            <input type="text" name='provincia-localidad' placeholder='PROVINCIA Y LOCALIDAD *' required/>
                        </label>
                    </div>
                    <div className="formGroup">
                    ...
                    <div className="formGroup">
                        <label htmlFor="instagram">
                            <input type="text" name='instagram' placeholder='INSTAGRAM DEL LOCAL *' required/>
                        </label>
                        <label htmlFor="facebook">
                            <input type="text" name='facebook' placeholder='FACEBOOK DEL LOCAL *' required/>
                        </label>
                    </div>
                    <div className='formGroup'>
